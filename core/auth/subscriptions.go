...
var _ = pubsub.NewSubscription(webhooks.NewClerkUsers, "create-user-account", pubsub.SubscriptionConfig[dto.ClerkEvent[dto.ClerkNewUserEventData]]{
	Handler: onClerkEvent,
})

func onClerkEvent(ctx context.Context, msg dto.ClerkEvent[dto.ClerkNewUserEventData]) (err error) {
	data := msg.Data
	switch msg.Type {
